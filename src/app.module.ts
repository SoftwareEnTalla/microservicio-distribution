...
import { DistributionCommandController } from "./modules/distribution/controllers/distributioncommand.controller";
import { DistributionModule } from "./modules/distribution/modules/distribution.module";
import { CqrsModule } from "@nestjs/cqrs";
import { AppDataSource, initializeDatabase } from "./data-source";
import { DistributionQueryController } from "./modules/distribution/controllers/distributionquery.controller";
import { GraphQLModule } from "@nestjs/graphql";
import { ApolloDriver, ApolloDriverConfig } from "@nestjs/apollo";
import GraphQLJSON from "graphql-type-json";
import { DistributionCommandService } from "./modules/distribution/services/distributioncommand.service";
import { DistributionQueryService } from "./modules/distribution/services/distributionquery.service";
import { CacheModule } from "@nestjs/cache-manager";
import { LoggingModule } from "./modules/distribution/modules/logger.module";
...
@Module({
  imports: [
    ...
    /**
     * Módulos Distribution de la aplicación
     */
    CqrsModule,
    HorizontalModule,
    DistributionModule,
  ...
  /**
   * Controladores de Distribution
   *
   * Registro de controladores a nivel de aplicación.
   */
  controllers: [
  //No se recomienda habilitar los controladores si ya fueron declarados en el módulo: DistributionModule
  /*
  
  DistributionCommandController, 
  DistributionQueryController
  
  */
  ],

  /**
   * Proveedores (Servicios, Repositorios, etc.) de Distribution
   *
   ...
   */
  exports: [DistributionCommandService, DistributionQueryService,LoggerService],
})
export class DistributionAppModule implements OnModuleInit {
  /**
