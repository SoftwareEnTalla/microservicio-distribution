...
export class DistributionService {
  ...
  // Métodos delegados
  async findAll(options?: any): Promise<Distribution[]> {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<Distribution[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<Distribution[]> {
  ...
  async findOne(where?: Record<string, any>): Promise<Distribution | null> {
  ...
  async update(id: string, partialEntity: Partial<Distribution>): Promise<Distribution | null> {
