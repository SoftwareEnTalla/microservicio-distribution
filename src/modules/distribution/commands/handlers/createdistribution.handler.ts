...
import { CreateDistributionCommand } from "../createdistribution.command";
import { DistributionCommandService } from "../../services/distributioncommand.service";

@CommandHandler(CreateDistributionCommand)
export class CreateDistributionHandler
  implements ICommandHandler<CreateDistributionCommand>
{
  constructor(
    private readonly commandService: DistributionCommandService
  ) {}
  async execute(command: CreateDistributionCommand) {
