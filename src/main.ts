...
import { DistributionAppModule } from "./app.module";
...
async function bootstrap() {
  ...
  try {
    ...
    logger.info(`ℹCreando instancia del módulo DistributionAppModule...`);
    const app = await NestFactory.create(DistributionAppModule, {
    ...
    const swaggerPath = setupSwagger(
      ...
      "API completa para gestión de Distributions con documentación automática",
      "1.0"
    );
